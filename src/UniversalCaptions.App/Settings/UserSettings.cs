...
/// environment knobs (<c>UC_GEMINI_*</c>, model selection) are deliberately NOT part of this model —
/// they stay environment-variable driven.
///
...
///
/// Schema v3 (ADR-0011): the v2 <c>Provider</c> field is removed — Gemini is the only speech engine,
/// so there is no provider choice to persist. The tolerant loader ignores stale fields, so a v2 file
...
public sealed record UserSettings
{
    ...
    /// <summary>The source-language hint for transcription/translation; null = auto-detect.</summary>
    public string? Language { get; init; }

    /// <summary>True when translation is enabled; null = default (off).</summary>
    public bool? TranslationEnabled { get; init; }

    /// <summary>The translation target language; null = default.</summary>
