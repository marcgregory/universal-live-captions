...
- Tests (335 total, all passing): `UniversalCaptions.Audio.Tests` (77), `UniversalCaptions.Captions.Tests` (72), `UniversalCaptions.Speech.Tests` (77), `UniversalCaptions.Translation.Tests` (27), `UniversalCaptions.App.Tests` (82) — see `docs/reports/TEST_REPORT.md`.
